...
from data.frame_sampling_utils import compute_ranking
...
def save_ply_visualization_cpu_batch(
    ...
    if save_depth:
        ...
        pcd_gt.points = o3d.utility.Vector3dVector(gt_pts)
        pcd_gt.colors = o3d.utility.Vector3dVector(colors)
        o3d.io.write_point_cloud(osp.join('save_path', save_name, f"{view_info}_{cur_step}_GT_pointcloud_numI{seq_len}.ply"), pcd_gt)
